...
public class GameOverScreen3 implements Screen {
    private Viewport viewport;
    private Stage stage;

    private Game game;

    public GameOverScreen3(Game game){
        this.game = game;
        ...
        Label playAgainLabel = new Label("Click to Restart the Level", font);
    ...
    public void render(float delta) {
        if(Gdx.input.justTouched()) {
            game.setScreen(new Level3((Prototype) game));
            dispose();
        }
