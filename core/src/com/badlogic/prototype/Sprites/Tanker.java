...
public class Tanker extends Sprite
{
    //states
    public enum State {DEATH, IDLE, HURT, MOVE, CD, ATTACK}
    ...
    public Tanker(Level1 screen)
    {
        ...
        movingRight=true;
        //anims and frames
        textureAtlas = new TextureAtlas(Gdx.files.internal("Enemies/Tank/Tank.atlas"));
        deathFrames=textureAtlas.findRegions("death");
        deathAnim = new Animation(1/11f,deathFrames);
    ...
    public void defineFlier()
    {
        ...
        fDef.shape=shape;
        fDef.friction=0; //movement is dictated, friction should not be issue (hopefully)
